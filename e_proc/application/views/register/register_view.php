<?php 
	$this->load->view('layout/header_registration');
...
<body id="login">
		...
		<header id="header">
			...
			<span id="login-header-space"> <span class="hidden-mobile">Sudah terdaftar?</span> <a href="<?php echo site_url('navigation');?>" class="btn btn-danger">Masuk</a> </span>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<img src="<?php echo base_url();?>resources/images/maersk-logo2.bmp" alt="" class="pull-right display-image" >
						...
						<div class="well no-padding">
							...
							<form action="php/demo-register.php" id="smart-form-register" class="smart-form client-form">
								...
								<fieldset>
									...
									<section>
											<label class="label">Company Services</label>
...
Contractology supply a wide variety of commercial legal documents, such as <a href="#">template data protection statements</a>.
	 ...
	 use of the template.</strong></p>
		...
		<?php 
			$this->load->view('layout/footer_registration');
